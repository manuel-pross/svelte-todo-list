...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span0 = element("span");
    			span0.textContent = "Manuel's To-Do List";
    			t1 = space();
    			span1 = element("span");
    			t2 = text(/*completedItemCount*/ ctx[1]);
    			t3 = text("/");
    			t4 = text(/*itemCount*/ ctx[0]);
    			add_location(span0, file, 22, 4, 580);
    			add_location(span1, file, 23, 4, 618);
    			attr_dev(div, "class", "header svelte-1z04hm8");
    			add_location(div, file, 21, 0, 554);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$items*/ 4) {
    			 $$invalidate(0, itemCount = $items.length); //Wann immer sich items ändert, wird itemCount neu zugewiesen
    		}

    		if ($$self.$$.dirty & /*$items*/ 4) {
    			 $$invalidate(1, completedItemCount = $items.filter(item => item.completed).length);
    		}
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "text-input svelte-1fr9muo");
    			attr_dev(input0, "type", "text");
    			input0.readOnly = /*completed*/ ctx[1];
    			add_location(input0, file$1, 58, 4, 1324);
    			attr_dev(input1, "class", "completed-checkbox svelte-1fr9muo");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 65, 4, 1562);
    			attr_dev(li, "class", "item svelte-1fr9muo");
    			toggle_class(li, "completed", /*completed*/ ctx[1]);
    			add_location(li, file$1, 57, 0, 1245);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(li, "dblclick", /*dblclick_handler*/ ctx[9], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { id } = $$props, { text } = $$props, { completed } = $$props;
    ...
    class Item extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { id: 4, text: 0, completed: 1 });
    ...
    /* src\components\NewItem.svelte generated by Svelte v3.32.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1na8g60");
    			add_location(input, file$2, 34, 0, 705);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\DeleteItems.svelte generated by Svelte v3.32.1 */
    const file$3 = "src\\components\\DeleteItems.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Delete completed";
    			t1 = space();
    			button1 = element("button");
    			button1.textContent = "Delete all";
    			attr_dev(button0, "class", "btn svelte-8zfyfu");
    			add_location(button0, file$3, 41, 4, 796);
    			attr_dev(button1, "class", "btn svelte-8zfyfu");
    			add_location(button1, file$3, 42, 4, 885);
    			attr_dev(div, "class", "delete-wrapper svelte-8zfyfu");
    			add_location(div, file$3, 40, 0, 762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*handleClickDeleteCompleted*/ ctx[1], false, false, false),
    					listen_dev(button1, "click", /*handleClickDeleteAll*/ ctx[0], false, false, false)
    				];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("DeleteItems", slots, []);
    	const dispatch = createEventDispatcher();
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<DeleteItems> was created with unknown prop '${key}'`);
    	});
    	...
    	return [handleClickDeleteAll, handleClickDeleteCompleted];
    }

    class DeleteItems extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\List.svelte generated by Svelte v3.32.1 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "list-status");
    			add_location(p, file$4, 78, 8, 1935);
    		},
    		m: function mount(target, anchor) {
    ...
    // (76:4) {#each itemsSorted as item (item)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(76:4) {#each itemsSorted as item (item)}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let current;
    	deleteitems = new DeleteItems({ $$inline: true });
    	deleteitems.$on("deleteAll", /*handleClickDeleteAll*/ ctx[5]);
    	deleteitems.$on("deleteCompleted", /*handleClickDeleteCompleted*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			create_component(deleteitems.$$.fragment);
    			t0 = space();
    			ul = element("ul");
    			...
    			attr_dev(ul, "class", "list svelte-ssb7e2");
    			add_location(ul, file$4, 73, 0, 1733);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(deleteitems, target, anchor);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(deleteitems.$$.fragment, local);
    		...
    		o: function outro(local) {
    			transition_out(deleteitems.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			destroy_component(deleteitems, detaching);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let $items;
    	validate_store(items, "items");
    	component_subscribe($$self, items, $$value => $$invalidate(6, $items = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function handleClickDeleteCompleted() {
    		set_store_value(items, $items = $items.filter(item => !item.completed), $items);
    		TodoApi.save($items);
    	}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$items, itemsSorted*/ 65) {
    			 {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-19bcnlr");
    			add_location(div, file$5, 24, 0, 330);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
