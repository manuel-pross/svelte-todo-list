    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$3, 25, 4, 454);
    			add_location(button1, file$3, 26, 4, 531);
    			attr_dev(div, "class", "delete-wrapper svelte-3lf5mu");
    			add_location(div, file$3, 24, 0, 420);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
